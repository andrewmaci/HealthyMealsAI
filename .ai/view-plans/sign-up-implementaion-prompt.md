...
The final output should be in English and saved in a file named `.ai/sign-up-view-implementation-plan.md`. Do not include any analysis and planning in the final output.
